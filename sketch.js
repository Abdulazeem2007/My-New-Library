...
function preload(){
    ...
    saturnI = loadImage('download.jpg');
...
function setup(){
   ...
   planet4 = createSprite(500,500,5,5);
   planet4.addImage(planet4I);
   planet4.scale = 0.15;

   planet5 = createSprite(300,500,5,5)
   planet5.addImage(saturnI);
   planet5scale = 0.15;
...
function draw(){
    ...
    planet5.setCollider("circle",0,0, planet5.width/2);
    ...
    ellipse(windowWidth/2, windowHeight/2, 1400);
